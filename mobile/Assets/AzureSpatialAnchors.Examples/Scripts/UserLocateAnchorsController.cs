...
{
    public class UserLocateAnchorsController : ArAppScriptBase
    {
        ...
        {
            { AppState.StepChooseFlow,new StepParams() { StepMessage = "Start locating anchors", StepColor = Color.clear }},
            ...
            { AppState.StepLookingForAnchor,new StepParams() { StepMessage = "Looking for anchors...press next to stop looking.", StepColor = Color.clear }},
            { AppState.StepLookedForAnchor,new StepParams() { StepMessage = "Looked for anchors.", StepColor = Color.clear }},
            { AppState.StepStopSessionForQuery,new StepParams() { StepMessage = "Session stopped.", StepColor = Color.yellow }},
        ...
        private AppState _currentAppState = AppState.StepCreateSession;
        private Flow _currentFlow = Flow.LocateFlow;
...
#pragma warning restore CS1998
        {
            Debug.Log("Initaliselocateflow");
            if (currentAppState == AppState.StepCreateSession)
            {
